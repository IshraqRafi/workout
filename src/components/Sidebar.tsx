...
import { Activity, Dumbbell, Calendar, User as UserIcon, Settings, Menu, X, Flame, LogOut } from 'lucide-react';
...
export function Sidebar() {
    ...
    return (
        <>
            {/* Mobile Toggle */}
            <button
                className="mobile-toggle glass-pill flex-center"
                        ...
                        >
                            <div className="glass-pill" style={{ padding: '1rem', display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'flex-start', width: '100%', cursor: 'pointer' }}>
                                ...
                                <div style={{ overflow: 'hidden' }}>
                                    <p style={{ fontWeight: 600, fontSize: '0.9rem', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>Ishraq Rafi</p>
                                    <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>Pro Member</p>
                                </div>
                            </div>
